...
function HeroSection() {
    ...
    useEffect(() => {
        const positions = ["Junior Web Developer", "Software Engineer", "Programmer", "UI/UX Design", "Cloud AWS Basic", "IT Enthusiast"];
        let index = 0;
            ...
            <Row>
                <Col lg="6" md="6">
                    <div className='hero_content'>
                        ...
                        <h4>I^m <span className='typed-text gelar'></span></h4>
                        ...
                        <div className='mt-5 hero_btns d-flex align-items-center gap-4'>
                            ...
                            <button className='btn cv_btn'><a href='https://drive.google.com/file/d/1NtmKLaJIlAIgpD-iXaQbMetPy3iJOCiY/view?usp=drive_link' className='text-white'> Checkout my CV <i className="ri-send-plane-fill"></i></a></button>
                        </div>
                    </div>
                </Col>
