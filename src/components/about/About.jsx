                ...
                <Col lg="8" md="9">
                    {
                        ...
                        <div className="about_content w-75">
                            ...
                            <p>Fresh Graduate Diploma 3 Jurusan Sistem Informasi di Universitas Bina Sarana Informatika. 
                                Seorang yang kreatif, rajin, berkomitmen, dan bertanggung jawab. Memiliki pengalaman 
                                Magang di PT Chairos International Ventures posisi Cloud Computing selama 5 Bulan di 
                                program MSIB Kampus Merdeka/MBKM. Dan pengalaman di Ponpes Riyadush Sholihin Tegal sebagai 
                                Web Developer. Kemampuan yang dikuasai adalah php, html, css, JavaScript, Python, MySQL database, 
                                Potsgree SQL, Figma dan AWS Cloud.</p>

                            <div className="social_links">
                                <h6 className="mb-3">Connect with me in Social Media:</h6>
                                <span><a href="https://web.facebook.com/riio2367/"><i className="ri-facebook-line"></i></a></span>
                                <span><a href="https://www.linkedin.com/in/akhmadazizmario/"><i className="ri-linkedin-line"></i></a></span>
                                <span><a href="https://www.instagram.com/azizmario_/"><i className="ri-instagram-line"></i></a></span>
                                <span><a href="https://github.com/akhmadazizmario"><i className="ri-github-line"></i></a></span>
                            </div>
                        </div>
